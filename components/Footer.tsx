    ...
    <footer className="relative overflow-hidden border-t border-gray-100 bg-white text-gray-700">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse closest-side, #60A5FA 0%, #388EE8 30%, rgba(56, 142, 232, 0.4) 70%, transparent 100%)",
          }}
        />
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative py-16 lg:py-20">
          ...
          <div className="sm:col-span-2 lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                ...
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-gray-100 text-[#0B3B8B] hover:bg-[#F0F7FF] transition-colors flex items-center justify-center"
              >
            ...
            <ul className="space-y-3 type-ui-control text-gray-600 font-normal">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="hover:text-[#0B3B8B] transition-colors inline-block"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3.5 type-ui-control text-gray-600 font-normal">
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-[#0B3B8B] shrink-0 mt-1" />
                <span>Nagarjun-3, Pachadhara, Swoyambhu, Kathmandu</span>
              </div>

              <div className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-[#0B3B8B] shrink-0" />
                <a href="tel:9861161359" className="hover:text-[#0B3B8B] transition-colors font-medium">
                  9861161359 / 01-4950352
                </a>
              </div>

              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-[#0B3B8B] shrink-0" />
                <a
                  href="mailto:grand.dentalclinic2079@gmail.com"
                  className="hover:text-[#0B3B8B] transition-colors font-medium"
                >
              ...
              <div className="flex items-start gap-3 pt-1">
                <Clock className="w-4 h-4 text-[#0B3B8B] shrink-0 mt-1" />
                <div>
                  <p className="font-semibold text-gray-800">Sun &ndash; Fri: 9:00 AM &ndash; 7:00 PM</p>
                  <p className="type-meta text-gray-500">Walk-ins Welcome: 9:00 AM &ndash; 6:00 PM</p>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-gray-100 pt-8 sm:flex-row type-meta text-gray-500">
          <p suppressHydrationWarning>&copy; {new Date().getFullYear()} Grand Dental Clinic. All rights reserved.</p>
          <div className="flex items-center space-x-6">
            <Link href="/privacy" className="hover:text-[#0B3B8B] transition-colors">
              Privacy Policy
            </Link>
            <span>•</span>
            <Link href="/terms" className="hover:text-[#0B3B8B] transition-colors">
              Terms &amp; Conditions
            </Link>
          </div>
        </div>
