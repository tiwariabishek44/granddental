        ...
        <div className="grid grid-cols-1 gap-x-10 gap-y-12 sm:grid-cols-2 lg:grid-cols-5 lg:gap-x-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2 space-y-6">
            <Link href="/" className="inline-flex items-center gap-3.5 group">
              <div className="relative h-12 w-12 shrink-0 flex items-center justify-center rounded-full border border-[#DBEAFE] bg-white p-0.5 shadow-2xs">
                <Image
                  src="/logo.png"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3.5 type-ui-control text-gray-600 font-normal">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:014950352" className="hover:text-[#0B3B8B] transition-colors font-medium">
