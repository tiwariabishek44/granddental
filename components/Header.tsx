        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-18">
            ...
            <nav className="hidden lg:flex items-center gap-1.5 xl:gap-3 text-[15px] xl:text-base font-medium">
              ...
              {/* Services now links directly to the services page; the dropdown is disabled. */}
              <div className="relative">
                ...
                {/* Previous mega menu is retained but hidden. */}
                <div
                  className={`hidden absolute top-full left-1/2 -translate-x-1/2 pt-3 w-[780px] transition-all duration-200 z-50 ${isServicesOpen
