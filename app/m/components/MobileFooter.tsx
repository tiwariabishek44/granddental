        ...
        <div className="space-y-3.5">
          <Link href="/" className="inline-flex items-center gap-2.5 select-none">
            ...
            <div className="flex flex-col justify-center">
              <span className="font-serif text-2xl sm:text-3xl font-normal tracking-tight text-gray-950 leading-none group-hover:text-[#0B3B8B] transition-colors">
                Grand Dental
              </span>
              <span className="text-[10px] font-bold tracking-[0.22em] uppercase text-[#0B3B8B] mt-1 font-sans">
